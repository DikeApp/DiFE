...
<title>SizeMonitoringFrameLayout (ReactAndroid 0.50.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="SizeMonitoringFrameLayout (ReactAndroid 0.50.3 API)";
        }
    }
    catch(err) {
    }
...
<div class="subNav">
<ul class="navList">
<li><a href="../../../../com/facebook/react/uimanager/SimpleViewManager.html" title="class in com.facebook.react.uimanager"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.OnSizeChangedListener.html" title="interface in com.facebook.react.uimanager"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../../../index.html?com/facebook/react/uimanager/SizeMonitoringFrameLayout.html" target="_top">Frames</a></li>
<li><a href="SizeMonitoringFrameLayout.html" target="_top">No&nbsp;Frames</a></li>
</ul>
...
<h2 title="Class SizeMonitoringFrameLayout" class="title">Class SizeMonitoringFrameLayout</h2>
</div>
...
<li>
<ul class="inheritance">
<li>com.facebook.react.uimanager.SizeMonitoringFrameLayout</li>
</ul>
</li>
</ul>
</li>
...
<dd><a href="../../../../com/facebook/react/ReactRootView.html" title="class in com.facebook.react">ReactRootView</a></dd>
</dl>
<hr>
<br>
<pre>public class <span class="typeNameLabel">SizeMonitoringFrameLayout</span>
extends android.widget.FrameLayout</pre>
<div class="block">Subclass of <code>FrameLayout</code> that allows registering for size change events. The main purpose
 for this class is to hide complexity of <code>ReactRootView</code> from the code under
 <code>com.facebook.react.uimanager</code> package.</div>
</li>
</ul>
</div>
<div class="summary">
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.OnSizeChangedListener.html" title="interface in com.facebook.react.uimanager">SizeMonitoringFrameLayout.OnSizeChangedListener</a></span></code>&nbsp;</td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.html#SizeMonitoringFrameLayout-android.content.Context-">SizeMonitoringFrameLayout</a></span>(android.content.Context&nbsp;context)</code>&nbsp;</td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.html#SizeMonitoringFrameLayout-android.content.Context-android.util.AttributeSet-">SizeMonitoringFrameLayout</a></span>(android.content.Context&nbsp;context,
                         android.util.AttributeSet&nbsp;attrs)</code>&nbsp;</td>
</tr>
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.html#SizeMonitoringFrameLayout-android.content.Context-android.util.AttributeSet-int-">SizeMonitoringFrameLayout</a></span>(android.content.Context&nbsp;context,
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.html#onSizeChanged-int-int-int-int-">onSizeChanged</a></span>(int&nbsp;w,
             int&nbsp;h,
             int&nbsp;oldw,
             int&nbsp;oldh)</code>&nbsp;</td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.html#setOnSizeChangedListener-com.facebook.react.uimanager.SizeMonitoringFrameLayout.OnSizeChangedListener-">setOnSizeChangedListener</a></span>(<a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.OnSizeChangedListener.html" title="interface in com.facebook.react.uimanager">SizeMonitoringFrameLayout.OnSizeChangedListener</a>&nbsp;onSizeChangedListener)</code>&nbsp;</td>
</tr>
</table>
<ul class="blockList">
...
<code>checkLayoutParams, generateDefaultLayoutParams, generateLayoutParams, generateLayoutParams, getAccessibilityClassName, getConsiderGoneChildrenWhenMeasuring, getMeasureAllChildren, onLayout, onMeasure, setForegroundGravity, setMeasureAllChildren, shouldDelayChildPressedState</code></li>
</ul>
<ul class="blockList">
...
<a name="SizeMonitoringFrameLayout-android.content.Context-">
<!--   -->
</a>
<ul class="blockList">
<li class="blockList">
<h4>SizeMonitoringFrameLayout</h4>
<pre>public&nbsp;SizeMonitoringFrameLayout(android.content.Context&nbsp;context)</pre>
</li>
</ul>
<a name="SizeMonitoringFrameLayout-android.content.Context-android.util.AttributeSet-">
<!--   -->
</a>
<ul class="blockList">
<li class="blockList">
<h4>SizeMonitoringFrameLayout</h4>
<pre>public&nbsp;SizeMonitoringFrameLayout(android.content.Context&nbsp;context,
                                 android.util.AttributeSet&nbsp;attrs)</pre>
</li>
</ul>
<a name="SizeMonitoringFrameLayout-android.content.Context-android.util.AttributeSet-int-">
<!--   -->
</a>
...
<h3>Method Detail</h3>
<a name="setOnSizeChangedListener-com.facebook.react.uimanager.SizeMonitoringFrameLayout.OnSizeChangedListener-">
<!--   -->
</a>
<ul class="blockList">
<li class="blockList">
<h4>setOnSizeChangedListener</h4>
<pre>public&nbsp;void&nbsp;setOnSizeChangedListener(<a href="../../../../com/facebook/react/uimanager/SizeMonitoringFrameLayout.OnSizeChangedListener.html" title="interface in com.facebook.react.uimanager">SizeMonitoringFrameLayout.OnSizeChangedListener</a>&nbsp;onSizeChangedListener)</pre>
</li>
</ul>
