...
<title>ReactSlider (ReactAndroid 0.50.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="ReactSlider (ReactAndroid 0.50.3 API)";
        }
    }
    catch(err) {
    }
...
<ul class="navList">
<li>Prev&nbsp;Class</li>
<li><a href="../../../../../com/facebook/react/views/slider/ReactSliderEvent.html" title="class in com.facebook.react.views.slider"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../../../../index.html?com/facebook/react/views/slider/ReactSlider.html" target="_top">Frames</a></li>
<li><a href="ReactSlider.html" target="_top">No&nbsp;Frames</a></li>
</ul>
...
<ul class="subNavList">
<li>Summary:&nbsp;</li>
<li><a href="#nested.classes.inherited.from.class.android.widget.SeekBar">Nested</a>&nbsp;|&nbsp;</li>
...
<h2 title="Class ReactSlider" class="title">Class ReactSlider</h2>
</div>
...
<li>
<ul class="inheritance">
<li>android.widget.AbsSeekBar</li>
<li>
<ul class="inheritance">
<li>android.widget.SeekBar</li>
<li>
<ul class="inheritance">
<li>com.facebook.react.views.slider.ReactSlider</li>
</ul>
</li>
</ul>
</li>
...
<hr>
<br>
<pre>public class <span class="typeNameLabel">ReactSlider</span>
extends android.widget.SeekBar</pre>
<div class="block">Slider that behaves more like the iOS one, for consistency.
...
<ul class="blockList">
<li class="blockList"><a name="nested.classes.inherited.from.class.android.widget.SeekBar">
<!--   -->
</a>
<h3>Nested classes/interfaces inherited from class&nbsp;android.widget.SeekBar</h3>
<code>android.widget.SeekBar.OnSeekBarChangeListener</code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../../com/facebook/react/views/slider/ReactSlider.html#ReactSlider-android.content.Context-android.util.AttributeSet-int-">ReactSlider</a></span>(android.content.Context&nbsp;context,
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../../com/facebook/react/views/slider/ReactSlider.html#toRealProgress-int-">toRealProgress</a></span>(int&nbsp;seekBarProgress)</code>
<div class="block">Convert SeekBar's native progress value (e.g.</div>
</td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.android.widget.SeekBar">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;android.widget.SeekBar</h3>
<code>getAccessibilityClassName, setOnSeekBarChangeListener</code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.android.widget.AbsSeekBar">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;android.widget.AbsSeekBar</h3>
<code>drawableHotspotChanged, drawableStateChanged, getKeyProgressIncrement, getSplitTrack, getThumb, getThumbOffset, getThumbTintList, getThumbTintMode, jumpDrawablesToCurrentState, onDraw, onKeyDown, onMeasure, onRtlPropertiesChanged, onSizeChanged, onTouchEvent, setKeyProgressIncrement, setMax, setSplitTrack, setThumb, setThumbOffset, setThumbTintList, setThumbTintMode, verifyDrawable</code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.android.widget.ProgressBar">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;android.widget.ProgressBar</h3>
<code>getIndeterminateDrawable, getIndeterminateTintList, getIndeterminateTintMode, getInterpolator, getMax, getProgress, getProgressBackgroundTintList, getProgressBackgroundTintMode, getProgressDrawable, getProgressTintList, getProgressTintMode, getSecondaryProgress, getSecondaryProgressTintList, getSecondaryProgressTintMode, incrementProgressBy, incrementSecondaryProgressBy, invalidateDrawable, isIndeterminate, onAttachedToWindow, onDetachedFromWindow, onRestoreInstanceState, onSaveInstanceState, onVisibilityChanged, postInvalidate, setIndeterminate, setIndeterminateDrawable, setIndeterminateDrawableTiled, setIndeterminateTintList, setIndeterminateTintMode, setInterpolator, setInterpolator, setProgress, setProgressBackgroundTintList, setProgressBackgroundTintMode, setProgressDrawable, setProgressDrawableTiled, setProgressTintList, setProgressTintMode, setSecondaryProgress, setSecondaryProgressTintList, setSecondaryProgressTintMode, setVisibility</code></li>
</ul>
<ul class="blockList">
...
<a name="ReactSlider-android.content.Context-android.util.AttributeSet-int-">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>ReactSlider</h4>
<pre>public&nbsp;ReactSlider(android.content.Context&nbsp;context,
                   @Nullable
                   android.util.AttributeSet&nbsp;attrs,
                   int&nbsp;style)</pre>
</li>
...
<h3>Method Detail</h3>
<a name="toRealProgress-int-">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>toRealProgress</h4>
<pre>public&nbsp;double&nbsp;toRealProgress(int&nbsp;seekBarProgress)</pre>
<div class="block">Convert SeekBar's native progress value (e.g. 0..100) to a value
 passed to JS (e.g. -1.0..2.5).</div>
</li>
</ul>
</li>
</ul>
