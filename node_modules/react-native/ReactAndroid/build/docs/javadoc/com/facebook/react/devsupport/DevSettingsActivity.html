...
<title>DevSettingsActivity (ReactAndroid 0.50.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="DevSettingsActivity (ReactAndroid 0.50.3 API)";
        }
    }
    catch(err) {
    }
...
<div class="subNav">
<ul class="navList">
<li><a href="../../../../com/facebook/react/devsupport/DevServerHelper.SymbolicationListener.html" title="interface in com.facebook.react.devsupport"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../../../com/facebook/react/devsupport/DevSupportManagerFactory.html" title="class in com.facebook.react.devsupport"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../../../index.html?com/facebook/react/devsupport/DevSettingsActivity.html" target="_top">Frames</a></li>
<li><a href="DevSettingsActivity.html" target="_top">No&nbsp;Frames</a></li>
</ul>
...
<ul class="subNavList">
<li>Summary:&nbsp;</li>
<li><a href="#nested.classes.inherited.from.class.android.preference.PreferenceActivity">Nested</a>&nbsp;|&nbsp;</li>
<li><a href="#fields.inherited.from.class.android.preference.PreferenceActivity">Field</a>&nbsp;|&nbsp;</li>
...
<h2 title="Class DevSettingsActivity" class="title">Class DevSettingsActivity</h2>
</div>
...
<li>
<ul class="inheritance">
<li>android.app.ListActivity</li>
<li>
<ul class="inheritance">
<li>android.preference.PreferenceActivity</li>
<li>
<ul class="inheritance">
<li>com.facebook.react.devsupport.DevSettingsActivity</li>
</ul>
</li>
</ul>
</li>
...
<hr>
<br>
<pre>public class <span class="typeNameLabel">DevSettingsActivity</span>
extends android.preference.PreferenceActivity</pre>
<div class="block">Activity that display developers settings. Should be added to the debug manifest of the app. Can
 be triggered through the developers option menu displayed by <code>DevSupportManager</code>.</div>
</li>
</ul>
</div>
<div class="summary">
...
<ul class="blockList">
<li class="blockList"><a name="nested.classes.inherited.from.class.android.preference.PreferenceActivity">
<!--   -->
</a>
<h3>Nested classes/interfaces inherited from class&nbsp;android.preference.PreferenceActivity</h3>
<code>android.preference.PreferenceActivity.Header</code></li>
</ul>
</li>
</ul>
<!-- =========== FIELD SUMMARY =========== -->
...
<h3>Field Summary</h3>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.android.preference.PreferenceActivity">
<!--   -->
</a>
<h3>Fields inherited from class&nbsp;android.preference.PreferenceActivity</h3>
<code>EXTRA_NO_HEADERS, EXTRA_SHOW_FRAGMENT, EXTRA_SHOW_FRAGMENT_ARGUMENTS, EXTRA_SHOW_FRAGMENT_SHORT_TITLE, EXTRA_SHOW_FRAGMENT_TITLE, HEADER_ID_UNDEFINED</code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/devsupport/DevSettingsActivity.html#DevSettingsActivity--">DevSettingsActivity</a></span>()</code>&nbsp;</td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a href="../../../../com/facebook/react/devsupport/DevSettingsActivity.html#onCreate-android.os.Bundle-">onCreate</a></span>(android.os.Bundle&nbsp;savedInstanceState)</code>&nbsp;</td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.android.preference.PreferenceActivity">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;android.preference.PreferenceActivity</h3>
<code>addPreferencesFromIntent, addPreferencesFromResource, findPreference, finishPreferencePanel, getPreferenceManager, getPreferenceScreen, hasHeaders, invalidateHeaders, isMultiPane, isValidFragment, loadHeadersFromResource, onActivityResult, onBuildHeaders, onBuildStartFragmentIntent, onContentChanged, onDestroy, onGetInitialHeader, onGetNewHeader, onHeaderClick, onIsHidingHeaders, onIsMultiPane, onListItemClick, onNewIntent, onPreferenceStartFragment, onPreferenceTreeClick, onRestoreInstanceState, onSaveInstanceState, onStop, setListFooter, setParentTitle, setPreferenceScreen, showBreadCrumbs, startPreferenceFragment, startPreferencePanel, startWithFragment, startWithFragment, switchToHeader, switchToHeader</code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.android.app.ListActivity">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;android.app.ListActivity</h3>
<code>getListAdapter, getListView, getSelectedItemId, getSelectedItemPosition, setListAdapter, setSelection</code></li>
</ul>
<ul class="blockList">
...
<a name="DevSettingsActivity--">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>DevSettingsActivity</h4>
<pre>public&nbsp;DevSettingsActivity()</pre>
</li>
</ul>
</li>
</ul>
...
<li class="blockList">
<h4>onCreate</h4>
<pre>public&nbsp;void&nbsp;onCreate(android.os.Bundle&nbsp;savedInstanceState)</pre>
<dl>
<dt><span class="overrideSpecifyLabel">Overrides:</span></dt>
<dd><code>onCreate</code>&nbsp;in class&nbsp;<code>android.preference.PreferenceActivity</code></dd>
</dl>
</li>
</ul>
</li>
