...
<title>ARTSurfaceView (ReactAndroid 0.50.3 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="ARTSurfaceView (ReactAndroid 0.50.3 API)";
        }
    }
    catch(err) {
    }
...
<div class="subNav">
<ul class="navList">
<li><a href="../../../../../com/facebook/react/views/art/ARTShapeViewManager.html" title="class in com.facebook.react.views.art"><span class="typeNameLink">Prev&nbsp;Class</span></a></li>
<li><a href="../../../../../com/facebook/react/views/art/ARTSurfaceViewManager.html" title="class in com.facebook.react.views.art"><span class="typeNameLink">Next&nbsp;Class</span></a></li>
</ul>
<ul class="navList">
<li><a href="../../../../../index.html?com/facebook/react/views/art/ARTSurfaceView.html" target="_top">Frames</a></li>
<li><a href="ARTSurfaceView.html" target="_top">No&nbsp;Frames</a></li>
</ul>
...
<ul class="subNavList">
<li>Summary:&nbsp;</li>
<li><a href="#nested.classes.inherited.from.class.android.view.TextureView">Nested</a>&nbsp;|&nbsp;</li>
<li><a href="#fields.inherited.from.class.android.view.View">Field</a>&nbsp;|&nbsp;</li>
<li><a href="#constructor.summary">Constr</a>&nbsp;|&nbsp;</li>
<li><a href="#methods.inherited.from.class.android.view.TextureView">Method</a></li>
</ul>
<ul class="subNavList">
<li>Detail:&nbsp;</li>
<li>Field&nbsp;|&nbsp;</li>
...
<h2 title="Class ARTSurfaceView" class="title">Class ARTSurfaceView</h2>
</div>
...
<li>
<ul class="inheritance">
<li>android.view.TextureView</li>
<li>
<ul class="inheritance">
<li>com.facebook.react.views.art.ARTSurfaceView</li>
</ul>
</li>
</ul>
</li>
...
<hr>
<br>
<pre>public class <span class="typeNameLabel">ARTSurfaceView</span>
extends android.view.TextureView</pre>
<div class="block">Custom <code>View</code> implementation that draws an ARTSurface React view and its children.</div>
</li>
</ul>
</div>
<div class="summary">
...
<ul class="blockList">
<li class="blockList"><a name="nested.classes.inherited.from.class.android.view.TextureView">
<!--   -->
</a>
<h3>Nested classes/interfaces inherited from class&nbsp;android.view.TextureView</h3>
<code>android.view.TextureView.SurfaceTextureListener</code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a href="../../../../../com/facebook/react/views/art/ARTSurfaceView.html#ARTSurfaceView-android.content.Context-">ARTSurfaceView</a></span>(android.content.Context&nbsp;context)</code>&nbsp;</td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.android.view.TextureView">
<!--   -->
</a>
<h3>Methods inherited from class&nbsp;android.view.TextureView</h3>
<code>buildLayer, draw, getBitmap, getBitmap, getBitmap, getLayerType, getSurfaceTexture, getSurfaceTextureListener, getTransform, isAvailable, isOpaque, lockCanvas, lockCanvas, onAttachedToWindow, onDraw, onSizeChanged, onVisibilityChanged, setLayerPaint, setLayerType, setOpaque, setSurfaceTexture, setSurfaceTextureListener, setTransform, unlockCanvasAndPost</code></li>
</ul>
<ul class="blockList">
...
<a name="ARTSurfaceView-android.content.Context-">
<!--   -->
</a>
<ul class="blockListLast">
<li class="blockList">
<h4>ARTSurfaceView</h4>
<pre>public&nbsp;ARTSurfaceView(android.content.Context&nbsp;context)</pre>
</li>
</ul>
</li>
</ul>
